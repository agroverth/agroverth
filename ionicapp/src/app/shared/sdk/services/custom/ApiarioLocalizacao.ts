...
/**
 * Api services for the `ApiarioLocalizacao` model.
 */
@Injectable()
export class ApiarioLocalizacaoApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `ApiarioLocalizacao` object.)
   * </em>
   */
   ...
   *
   * @param {any} id apiarioLocalizacao id
   *
   * @param {object} data Request data.
   *
  ...
  /**
   * Statistical information for apiarioLocalizacao registers.
   *
