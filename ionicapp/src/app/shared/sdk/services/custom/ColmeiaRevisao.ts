...
/**
 * Api services for the `ColmeiaRevisao` model.
 */
@Injectable()
export class ColmeiaRevisaoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id colmeiaRevisao id
   *
  ...
  /**
   * Statistical information for colmeiaRevisao registers.
   *
