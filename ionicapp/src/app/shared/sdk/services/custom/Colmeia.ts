...
/**
 * Api services for the `Colmeia` model.
 */
@Injectable()
export class ColmeiaApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Colmeia` object.)
   * </em>
   */
  public getApiario(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Statistical information for colmeia registers.
   *
