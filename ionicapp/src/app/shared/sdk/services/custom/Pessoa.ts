...
/**
 * Api services for the `Pessoa` model.
 */
@Injectable()
export class PessoaApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Pessoa` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for pessoa registers.
   *
