...
/**
 * Api services for the `ColmeiaColheitaItens` model.
 */
@Injectable()
export class ColmeiaColheitaItensApi extends BaseLoopBackApi {
  ...
  /**
   * Busca relação colheita de belongsTo.
   *
   * @param {any} id colmeiaColheitaItens id
   *
   ...
   * This usually means the response is a `ColmeiaColheitaItens` object.)
   * </em>
   */
  public getColheita(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/colmeiaColheitaItens/:id/colheita";
  ...
  public getColmeia(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/colmeiaColheitaItens/:id/colmeia";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public myRemote(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/colmeiaColheitaItens/my-remote";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
  ...
  /**
   * Statistical information for colmeiaColheitaItens registers.
   *
