...
/**
 * Api services for the `ColmeriaAnaliseFavo` model.
 */
@Injectable()
export class ColmeriaAnaliseFavoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id colmeriaAnaliseFavo id
   *
   ...
   * This usually means the response is a `ColmeriaAnaliseFavo` object.)
   * </em>
   */
  public getColmeia(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/colmeriaAnaliseFavos/:id/colmeia";
  ...
  public myRemote(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/colmeriaAnaliseFavos/my-remote";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
  ...
  /**
   * Statistical information for colmeriaAnaliseFavo registers.
   *
