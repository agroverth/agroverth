...
/**
 * Api services for the `ColmeiraTemperatura` model.
 */
@Injectable()
export class ColmeiraTemperaturaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id colmeiraTemperatura id
   *
   ...
   * This usually means the response is a `ColmeiraTemperatura` object.)
   * </em>
   */
  public getColmeia(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/colmeiraTemperaturas/:id/colmeia";
  ...
  public myRemote(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/colmeiraTemperaturas/my-remote";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
  ...
  /**
   * Statistical information for colmeiraTemperatura registers.
   *
