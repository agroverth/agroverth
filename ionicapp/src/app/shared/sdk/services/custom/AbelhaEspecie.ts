...
/**
 * Api services for the `AbelhaEspecie` model.
 */
@Injectable()
export class AbelhaEspecieApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `AbelhaEspecie` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for abelhaEspecie registers.
   *
